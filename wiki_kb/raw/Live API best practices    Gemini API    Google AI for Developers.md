...
tags:
  - "clippings"
---
This guide covers best practices you can follow to optimize your use of the Live API. See [Get started with Live API](https://ai.google.dev/gemini-api/docs/live) page for an overview and sample code for common use cases.
...
When using tools with Live API, be specific in your tool definitions. Be sure to tell Gemini under what conditions a tool call should be invoked. For more details, see [Tool definitions](#tool-definitions-example) in the example section.
...
For implementation details, see [Session management](https://ai.google.dev/gemini-api/docs/live-api/session-management).

## Examples

This example combines both the best practices and [guidelines for system instruction design](#system-instruction-guidelines) to guide the model's performance as a career coach.
